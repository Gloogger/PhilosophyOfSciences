...
在狭义相对论中，相对性仍然是一种测量效应，与物质的结构和性质没有联系。狭义相对论的时空仍然只是物体运动的框架，一个容器，时空本身还是保留了惯性的优越地位。广义相对论则把 _绝对运动_ 和 _惯性_ 赶出了物理学。将相对性发展为相对时空观，让时空获得
* 整体性，即时空不可分割为简单的三维空间和一维时间的算术相加，而是一个有机整体。
* 实在性，即时空和物质是不可分离的，时空不仅仅是物质存在的基本形式，还与物质一起组成自然界这个整体。
...
# 科学革命？
对于库恩来说，爱因斯坦的相对论是对于牛顿体系的革命，两个体系根本不能兼容，就如同哥白尼体系和托勒密体系不能相互兼容一样。Kuhn主张，只有在认识牛顿理论是错的之后，才能接受爱因斯坦的理论。但真的是这样吗？

## 反对意见
在某些条件下（低速弱场），牛顿体系可以看做是爱因斯坦体系的一种特例。因此，仍然可以在很多应用，比如工程方面，使用这个旧理论。如果这样理解，牛顿体系是爱因斯坦体系中的一种特殊情况，那么这两个 _范式_ 就不是互不兼容的，因为任一观点都不能与其自身的特例相冲突。

## 库恩的回应
用上述模式拯救理论的话，会使得理论的应用范围被限制在最初解释的现象内，且其精确程度，也只能限制在已有实验材料所能提供的限度内，并且这样的限制，会禁止科学家对任何尚未观察过的现象做任何科学的推测。
